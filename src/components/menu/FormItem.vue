            ...
            <div class="accordion-item">
              ...
              <div id="collapseCategory" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionCategory">
                <div class="accordion-body">
                  ...
                  <div v-if="categories.length > 0" class="mt-4 mb-2">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseComplement" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionComplement">
                <div class="accordion-body">
                  ...
                  <div v-if="itemData.complement.length > 0" class="mt-4 mb-2">
...
export default {
  ...
  methods: {
    ...
    async createItem() {
      try {
        ...
        formData.append('restaurant_id', 1); // Substitua pelo ID real do restaurante
        if (this.itemData.image) {
          const blob = await fetch(this.itemData.image).then(res => res.blob());
          formData.append('products_photo', blob, this.imageName);
          formData.append('products_cover', blob, this.imageName);
        }
  ...
  mounted() {
    ...
    if (this.itemEditData && Object.keys(this.itemEditData).length) {
      this.itemData = { ...this.itemEditData, complement: this.itemEditData.complement || [] };
      this.categories = this.itemEditData.categories || [];
    }
  }
};
</script>
